                     ...
                     <div class="full contact_form">
                        <form method="POST" class="contact_form_inner" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" enctype="multipart/form-data">
                           <fieldset>
                              ...
                              <div class="field">
                                 <input type="number" name="anime_capitulo_terminado" value="<?php echo $anime['anime_capitulo_terminado_ver'];?>" placeholder="Ultimo capítulo visto" min="1" required />
                              </div>
                              <div class="field">
                                 <textarea required style="border: 2px solid #ccc" name="anime_sinopsis" cols="15" rows="5" placeholder="Escriba la sinopsis aqui"><?php echo $anime['anime_sinopsis'];?></textarea>
                              </div>
                              <br />
                              <div class="field">
